...
o.trigger("activate.bs.scrollspy")},e.prototype.clear=function(){t(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var o=t.fn.scrollspy;t.fn.scrollspy=i,t.fn.scrollspy.Constructor=e,t.fn.scrollspy.noConflict=function(){return t.fn.scrollspy=o,this},t(window).on("load.bs.scrollspy.data-api",function(){t('[data-spy="scroll"]').each(function(){var e=t(this);i.call(e,e.data())})})}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),n=o.data("bs.tab");n||o.data("bs.tab",n=new i(this)),"string"==typeof e&&n[e]()})}var i=function(e){this.element=t(e)};i.VERSION="3.3.5",i.TRANSITION_DURATION=150,i.prototype.show=function(){var e=this.element,i=e.closest("ul:not(.dropdown-menu)"),o=e.data("target");if(o||(o=e.attr("href"),o=o&&o.replace(/.*(?=#[^\s]*$)/,"")),!e.parent("li").hasClass("active")){var n=i.find(".active:last a"),s=t.Event("hide.bs.tab",{relatedTarget:e[0]}),a=t.Event("show.bs.tab",{relatedTarget:n[0]});if(n.trigger(s),e.trigger(a),!a.isDefaultPrevented()&&!s.isDefaultPrevented()){var r=t(o);this.activate(e.closest("li"),i),this.activate(r,r.parent(),function(){n.trigger({type:"hidden.bs.tab",relatedTarget:e[0]}),e.trigger({type:"shown.bs.tab",relatedTarget:n[0]})})}}},i.prototype.activate=function(e,o,n){function s(){a.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),e.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),r?(e[0].offsetWidth,e.addClass("in")):e.removeClass("fade"),e.parent(".dropdown-menu").length&&e.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),n&&n()}var a=o.find("> .active"),r=n&&t.support.transition&&(a.length&&a.hasClass("fade")||!!o.find("> .fade").length);a.length&&r?a.one("bsTransitionEnd",s).emulateTransitionEnd(i.TRANSITION_DURATION):s(),a.removeClass("in")};var o=t.fn.tab;t.fn.tab=e,t.fn.tab.Constructor=i,t.fn.tab.noConflict=function(){return t.fn.tab=o,this};var n=function(i){i.preventDefault(),e.call(t(this),"show")};t(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',n).on("click.bs.tab.data-api",'[data-toggle="pill"]',n)}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),n=o.data("bs.affix"),s="object"==typeof e&&e;n||o.data("bs.affix",n=new i(this,s)),"string"==typeof e&&n[e]()})}var i=function(e,o){this.options=t.extend({},i.DEFAULTS,o),this.$target=t(this.options.target).on("scroll.bs.affix.data-api",t.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",t.proxy(this.checkPositionWithEventLoop,this)),this.$element=t(e),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};i.VERSION="3.3.5",i.RESET="affix affix-top affix-bottom",i.DEFAULTS={offset:0,target:window},i.prototype.getState=function(t,e,i,o){var n=this.$target.scrollTop(),s=this.$element.offset(),a=this.$target.height();if(null!=i&&"top"==this.affixed)return i>n?"top":!1;if("bottom"==this.affixed)return null!=i?n+this.unpin<=s.top?!1:"bottom":t-o>=n+a?!1:"bottom";var r=null==this.affixed,l=r?n:s.top,h=r?a:e;return null!=i&&i>=n?"top":null!=o&&l+h>=t-o?"bottom":!1},i.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(i.RESET).addClass("affix");var t=this.$target.scrollTop(),e=this.$element.offset();return this.pinnedOffset=e.top-t},i.prototype.checkPositionWithEventLoop=function(){setTimeout(t.proxy(this.checkPosition,this),1)},i.prototype.checkPosition=function(){if(this.$element.is(":visible")){var e=this.$element.height(),o=this.options.offset,n=o.top,s=o.bottom,a=Math.max(t(document).height(),t(document.body).height());"object"!=typeof o&&(s=n=o),"function"==typeof n&&(n=o.top(this.$element)),"function"==typeof s&&(s=o.bottom(this.$element));var r=this.getState(a,e,n,s);if(this.affixed!=r){null!=this.unpin&&this.$element.css("top","");var l="affix"+(r?"-"+r:""),h=t.Event(l+".bs.affix");if(this.$element.trigger(h),h.isDefaultPrevented())return;this.affixed=r,this.unpin="bottom"==r?this.getPinnedOffset():null,this.$element.removeClass(i.RESET).addClass(l).trigger(l.replace("affix","affixed")+".bs.affix")}"bottom"==r&&this.$element.offset({top:a-e-s})}};var o=t.fn.affix;t.fn.affix=e,t.fn.affix.Constructor=i,t.fn.affix.noConflict=function(){return t.fn.affix=o,this},t(window).on("load",function(){t('[data-spy="affix"]').each(function(){var i=t(this),o=i.data();o.offset=o.offset||{},null!=o.offsetBottom&&(o.offset.bottom=o.offsetBottom),null!=o.offsetTop&&(o.offset.top=o.offsetTop),e.call(i,o)})})}(jQuery),jQuery(function(){function t(){var t=$(window).width(),e=$(window).height();if($(".unit").each(function(){$(this).data("height")>0&&($(".navbar-fixed-top").length||$(".navbar-static").length?$(this).height((e-$(".navbar-fixed-top,.navbar-static").height())*$(this).data("height")):$(this).height(e*$(this).data("height")))}),t>l){var i=$(document).scrollTop();$(".parallax").each(function(t){$(this).data("offsetTop",$(this).offset().top),$(this).data("outerHeight",$(this).outerHeight());var o=100*($(this).data("offsetTop")-i)/(e-$(this).data("outerHeight"));$(this).css("background-position","center "+o+"%")})}else $(".parallax").css({"background-position":"center center"}),$(".parallax-intro").css("background-position","center top");n=$(window).height(),parallaxItems=$(".parallax").toArray();for(var o=0,h=parallaxItems.length;h>o;o++)parallaxItems[o]=$(parallaxItems[o]);if(a=$(document),r=$(".parallax-intro").length?$(".parallax-intro"):null,$(".custom-navbar-bottom").length){var d=$(".custom-navbar-bottom").next();l>=t?($("body").css("padding-top",$(".custom-navbar-bottom").height()),d.css("padding-bottom",0)):($("body").css("padding-top",0),d.css("padding-bottom",$(".custom-navbar-bottom").height())),1!=d.find(".unit").data("height")&&$(".custom-navbar-bottom").css("bottom",e-d.height()-$(".custom-navbar-bottom").height()),$(".custom-navbar-bottom").affix({offset:{top:d.height()}})}$(".navbar-fixed-top").length&&$("body").css("padding-top",$(".navbar-fixed-top").height()),s=$(".animate").toArray()}function e(t,e){return t.hasClass("animate-fade-in-from-under")?(t.delay(h*e).css({top:30,opacity:0}).animate({top:0,opacity:1},d),!0):t.hasClass("animate-fade-in-from-under-margin")?(t.delay(h*e).css({marginTop:100,opacity:0}).animate({marginTop:0,opacity:1},d),!0):t.hasClass("animate-fade-in")?(t.delay(h*e).css({opacity:0}).animate({opacity:1},d),!0):void 0}function i(t,i){var o;o=i?t.find(".animate-on-start.animate-fade-in,.animate-on-start.animate-fade-in-from-under,.animate-on-start.animate-fade-in-from-under-margin"):t.find(".animate-fade-in,.animate-fade-in-from-under,.animate-fade-in-from-under-margin"),o.each(function(t){t++,e($(this),t)})}function o(t){var e=$(t),i=$(window),o=i.scrollTop(),n=o+i.height(),s=e.offset().top,a=s+e.height();return n>=a&&s>=o}var n,s,a,r,l=768,h=500,d=500;$(window).resize(function(){t()}),$(window).ready(function(){t(),$("#preloader").delay(200).fadeOut(200,function(){i($("body"),!0)}),$(function(){$("a[href*=#]:not([href=#])").click(function(){if($(".navbar").find(".active").removeClass("active"),$(this).parent("li").addClass("active"),location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")||location.hostname==this.hostname){var t=$(this.hash);if(t=t.length?t:$("[name="+this.hash.slice(1)+"]"),t.length)return $("html,body").animate({scrollTop:t.offset().top-$(".navbar").height()+2},1e3),!1}})})}),$(window).scroll(function(){if($(window).width()>l){for(var t=a.scrollTop(),i=0,h=parallaxItems.length;h>i;i++){var d=100*(parallaxItems[i].data("offsetTop")-t)/(n-parallaxItems[i].data("outerHeight"));parallaxItems[i].css({backgroundPosition:"center "+d+"%"})}r&&r.css("background-position","center "+$(document).scrollTop()/1.8+"px")}for(var i=0,h=s.length;h>i;i++)o($(s[i]))&&0==$(s[i]).css("opacity")&&e($(s[i]),0)})});